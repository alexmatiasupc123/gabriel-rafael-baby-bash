  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 py-12 overflow-hidden">
      ...
      <div className="relative z-20 text-center max-w-md mx-auto">
        ...
        <h2 className="font-script text-5xl md:text-7xl text-baby-blue-dark mb-8 animate-fade-in-up delay-300 bg-baby-blue/80 px-6 py-2 rounded-full backdrop-blur-sm">
          Rafael
        </h2>
